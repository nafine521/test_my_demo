...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Q2/tp1611/Public/Home/styles/contact.css" />
	...
	<script type="text/javascript" src="/Q2/tp1611/Public/Home/scripts/page_contact.js"></script>
</head>
<body>
    ...
    <?php if($promo_pro): ?><li class="buy" style="background:url('/Q2/tp1611<?php echo ($promo_pro["img"]); ?>') no-repeat center center;">
        <a href="<?php echo U('Product/product',array('id'=>$promo_pro['id']));?>" title="热卖产品"><img src="/Q2/tp1611/Public/Home/images/bg/sidebar_buy.png" title="点击购买" id="buyHot"></a>
			...
			<form action="" method="post" class="main_text ff_yh fs_14" id="form-content">
				...
				<?php if(!empty($_SESSION['tp1611_user'])): ?><input type="hidden" name="uid" value="<?php echo ($_SESSION['tp1611_user']['id']); ?>"><?php endif; ?>
				<!-- 清除浮动样式 -->
				<div class="clear"></div>
				...
				<img src="<?php echo U('Index/verify');?>" class="box"  id="verifySrc" onclick="verify()" style="cursor: pointer;"/>
	  ...
	  $("#form-content").Validform({
	      ...
	      callback:function(form){
	            if(form.status=='y'){
	                setTimeout(function () {
	                    $.Hidemsg();
	                    location.href="<?php echo U('contact');?>";//刷新窗口
	                },1000);
	            }
	        }
	  });
