...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Q2/tp1611/Public/Home/styles/introduction.css" />
        ...
        <a href="<?php echo U('Product/product',array('id'=>$promo_pro['id']));?>" title="热卖产品"><img src="/Q2/tp1611/Public/Home/images/bg/sidebar_buy.png" title="点击购买" id="buyHot"></a>
			...
			<div class="main_text ff_simsun fs_14">
				<p class="current_location ff_fz">
					...
					&gt;&gt;
					<a href="<?php echo U('Brand/introduction');?>" class="current">品牌介绍</a>
				</p>
				<div class="intro">
					<span class="border_top"></span>
					<div class="intro_text">
						<img src="/Q2/tp1611<?php echo ($brand["img"]); ?>" />
						<p><?php echo ($brand["content"]); ?></p>
						<a href="<?php echo U('News/news');?>" class="more">更多&gt;&gt;</a>
						<!-- 清除浮动样式 -->
						<div class="clear"></div>
					</div>
