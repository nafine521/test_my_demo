...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-product-add">
		...
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>显示页面：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select name="local" class="select">
					<option value="0"  <?php if($info["local"] == '0'): ?>selected<?php endif; ?> >首页</option>
					<option value="1"  <?php if($info["local"] == '1'): ?>selected<?php endif; ?> >其他页</option>
				</select>
				</span> </div>
            <div class="col-3"> </div>
		</div>
...
<script type="text/javascript">
    ...
    var editor = K.editor({
        ...
        uploadJson : "<?php echo U('Base/uploadImg',array('path'=>'banner','w'=>150,'h'=>80));?>", //上传功能
        fileManagerJson : '/Q2/tp1611/Public/Admin/kindeditor/php/file_manager_json.php?dirpath=banner', //网络空间
      });  
    //上传背景图片
