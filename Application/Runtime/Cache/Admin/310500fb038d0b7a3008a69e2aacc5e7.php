...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-product-add">
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>所属产品：</label>
			<div class="formControls col-2"> <span class="select-box">
				<select name="pro_id" class="select" datatype="*" nullmsg="请选择产品名">
					<option value="">全部栏目</option>
					<?php if(is_array($proList)): foreach($proList as $k=>$v): ?><option value="<?php echo ($k); ?>" <?php if($info['pro_id'] == $k OR $pro_id == $k): ?>selected<?php endif; ?> >├<?php echo ($v); ?></option><?php endforeach; endif; ?>
				</select>
				</span> </div>
            <div class="col-3"> </div>
		</div>
		
		<?php if($info["id"] > 0 OR $firfox != false): ?><div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>图片：</label>
            <div class="formControls col-7"> 
                <img id="thumb_url" src='<?php if($info['img']): ?>/Q2/tp1611<?php echo ($info["img"]); else: ?>/Q2/tp1611/Public/Admin//nopic.jpg<?php endif; ?>' style="height:100px;width:150">
                <input type="hidden"  id="picurl" name="img" value="<?php echo ($info["img"]); ?>" datatype="*" nullmsg="请上传图片"/>
            ...
            <div class="formControls col-6"> 
                <div style="margin:0 auto; width:600px;height:340px;">
                    ...
                    <param name="allowFullScreen" value="false"/>
                        ...
                        <param name="movie" value="/Q2/tp1611/Public/Admin/pics/update.swf" />
                        <param name="quality" value="high" />
                        <param name="bgcolor" value="#ffffff" />
                        <embed src="/Q2/tp1611/Public/Admin/pics/update.swf" quality="high" bgcolor="#ffffff" width="700" height="340" name="update" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
                        </object>
                </div>
                <div id="show"></div>
            </div>
