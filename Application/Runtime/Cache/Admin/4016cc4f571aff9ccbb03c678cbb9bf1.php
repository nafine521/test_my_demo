...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 图片管理 <span class="c-gray en">&gt;</span> 产品相册图列表 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">

	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="picture_add('添加图片','<?php echo U('proPhotoAdd');?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加图片</a></span> <span class="r">共有数据：<strong><?php echo (count($list)); ?></strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td>
						...
						<span class="select-box"  style="text-align:center;">
						<select name="pro_id" class="select" onblur="saveVal(this,<?php echo ($v['id']); ?>,'pro_id')">
							<option value="">请选择产品</option>
							<?php if(is_array($proList)): foreach($proList as $k=>$vo): ?><option value="<?php echo ($k); ?>" <?php if($v['pro_id'] == $k): ?>selected<?php endif; ?> >├<?php echo ($vo); ?></option><?php endforeach; endif; ?>
						</select>
						</span> 
					</td>
					...
					<td>
						<a href="javascript:;" onClick="picture_edit('图片编辑','<?php echo U('Picture/proPhotoAdd',array('id'=>$v['id']));?>')"><img width="100" class="picture-thumb" src="/Q2/tp1611<?php echo ($v["img"]); ?>" alt="点击可修改图片" title="点击可修改图片"></a>
					</td>
					<td class="td-manage"> <a style="text-decoration:none" class="ml-5" onClick="picture_edit('图片编辑','<?php echo U('Picture/proPhotoAdd',array('id'=>$v['id']));?>')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onClick="picture_del(this,<?php echo ($v['id']); ?>)" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function saveVal(obj,id,field_name){
    ...
    $.post("<?php echo U('Base/status');?>",{"tableName":'pro_photo',"fieldName":field_name,"primary":'id','id':id,"fieldVal":field_new},function(res){
        if (res.status=="y") {
