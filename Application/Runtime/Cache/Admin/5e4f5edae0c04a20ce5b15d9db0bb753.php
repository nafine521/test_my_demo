			...
			<div class="tabCon" >
				...
				<div class="row cl">
					...
					<div class="formControls col-6">
						<input type="text" class="input-text" value="<?php echo ($info["name"]); ?>" name="name" datatype="*" nullmsg="名称不能为空">
					</div>
					<div class="col-3"> </div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-6">
						<input type="text" class="input-text" value="<?php echo ($info["link"]); ?>" name="link" datatype="*" nullmsg="请输入链接">
					</div>
					<div class="col-3"> </div>
				</div>
		<div class="row cl">
