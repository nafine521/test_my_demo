	...
	<form action="" method="post" class="form form-horizontal" id="form-nav-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-6">
				<input type="text" class="input-text" value="<?php echo (getNameById($pro_id,'product')); ?>" disabled placeholder=""  name="pro_id" datatype="*" nullmsg="图片名称不能为空">
			</div>
			<div class="col-3"> </div>
		</div>
		<?php if($info["id"] > 0): ?><div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>图片：</label>
			<div class="formControls col-7"> 
			    <img id="thumb_url" src='<?php if($info['img']): ?>/1611/1232/tp1611<?php echo ($info["img"]); else: ?>/1611/1232/tp1611/Public/Admin//nopic.jpg<?php endif; ?>' style="height:100px;width:150">
			  	<input type="hidden"  id="picurl" name="img" value="<?php echo ($info["img"]); ?>" datatype="*" nullmsg="请选择缩略图"/> 
			  	<input type="hidden" name="oldpic" value="<?php echo ($info["img"]); ?>" >
			...
			<div class="formControls col-6"> 
			    <div style="margin:0 auto; width:600px;height:340px;">
					...
					<param name="allowFullScreen" value="false"/>
						...
						<param name="movie" value="/1611/1232/tp1611/Public/Admin/pics/update.swf" />
					    <param name="quality" value="high" />
					    <param name="bgcolor" value="#ffffff" />
					    <embed src="/1611/1232/tp1611/Public/Admin/pics/update.swf" quality="high" bgcolor="#ffffff" width="700" height="340" name="update" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
						</object>
				</div>
				<div id="show"></div>
			</div>
...
<!-- 新增编辑器引入文件 -->
<link rel="stylesheet" href="/1611/1232/tp1611/Public/Admin/kindeditor/themes/default/default.css" />
<script src="/1611/1232/tp1611/Public/Admin/kindeditor/kindeditor-min.js"></script>
<script src="/1611/1232/tp1611/Public/Admin/kindeditor/lang/zh_CN.js"></script>
...
KindEditor.ready(function(K) {
	var editor = K.editor({
	    ...
	    fileManagerJson : '/1611/1232/tp1611/1611/1232/tp1611/Public/Admin/kindeditor/php/file_manager_json.php?dirpath=product', //网络空间
	  });  
	//上传背景图片
	K('#image').click(function() {
	  editor.loadPlugin('image', function() {
	    editor.plugin.imageDialog({
	        ...
	        K('#picurl').val(url);
	        $('#thumb_url').attr("src","/1611/1232/tp1611"+url);
	        editor.hideDialog();
	      }
	    });
	  });
...
<script type="text/javascript">
	...
	var editor = K.editor({
	    allowFileManager : true,       
	    uploadJson : "<?php echo U('Base/uploadImg',array('path'=>'product','w'=>150,'h'=>80));?>", //上传功能
	    fileManagerJson : '/1611/1232/tp1611/Public/Admin/kindeditor/php/file_manager_json.php?dirpath=product', //网络空间
	  });  
	//上传背景图片
	K('#image').click(function() {
	  editor.loadPlugin('image', function() {
